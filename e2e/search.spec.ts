...
test.describe('Global Search', () => {
  ...
  test('should show grouped results with icons and descriptions', async ({ page }) => {
    ...
    if (await firstGroup.isVisible()) {
      ...
      const groupLabel = firstGroup.locator('text=/İhtiyaç Sahipleri|Görevler|Toplantılar|Bağışlar/i');
  ...
  test('should navigate to beneficiary detail on click', async ({ page }) => {
    ...
    const beneficiaryResult = page.locator('[role="option"]').filter({ hasText: /İhtiyaç Sahipleri|Beneficiaries/i }).first();
  ...
  test('should navigate to task detail on click', async ({ page }) => {
    ...
    // Find task result
    const taskResult = page.locator('[role="option"]').filter({ hasText: /Görevler|Tasks/i }).first();
  ...
  test('should navigate to meeting detail on click', async ({ page }) => {
    ...
    // Find meeting result
    const meetingResult = page.locator('[role="option"]').filter({ hasText: /Toplantılar|Meetings/i }).first();
  ...
  test('should navigate to donation detail on click', async ({ page }) => {
    ...
    const donationResult = page.locator('[role="option"]').filter({ hasText: /Bağışlar|Donations/i }).first();
